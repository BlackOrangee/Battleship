...
char bang = bang_int;// Character symbol for the bang

char space = ' '; // Character symbol for an empty space
char cross = 'X'; // Character symbol for a cross (used for marking hits)
...
int difficulty = 3; // Game difficulty (percentage of hit probability)
...
bool tactic_2 = false;
bool tactics = false;
bool tactic_pc_2 = false;
bool tactic_first = false;